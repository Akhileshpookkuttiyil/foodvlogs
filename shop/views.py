...
def home(request, c_slug=None):
    ...
    return render(request, 'index.html', {'products': prodt, 'categories': cat, 'pages': pro})
...
def prod_details(request, c_slug, product_slug):
    ...
    return render(request, 'item.html', {'product': prod})
...
def searching(request):
    ...
    return render(request, 'search.html', {'query': query, 'products': prod})
